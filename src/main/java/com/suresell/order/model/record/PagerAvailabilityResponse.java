...
public record PagerAvailabilityResponse(Integer totalPagers, Integer availablePagers, Integer occupiedPagers, List<PagerAvailabilityDto> pagers) {
    private final Integer totalPagers;
    private final Integer availablePagers;
    private final Integer occupiedPagers;
    private final List<PagerAvailabilityDto> pagers;
